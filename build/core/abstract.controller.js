...
exports.commonController = function (service, commonRouter) {
    ...
    commonRouter.get("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = (_a = res).send;
                    return [4 /*yield*/, service.getById(Number(req.params.id))];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
    ...
    commonRouter.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = (_a = res).send;
                    return [4 /*yield*/, service.add(req.body)];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
    ...
    commonRouter.put("/update/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    commonRouter.delete("/delete/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
